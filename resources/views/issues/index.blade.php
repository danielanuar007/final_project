                                        ...
                                        @foreach ($issues as $singleIssue) 
                                            <tr> 
                                                <td class="px-6 py-4 text-left"> 
                                                    ...
                                                    @if ($singleIssue->project)
                                                        <h2 class="font-bold">{{ $singleIssue->project->title }}</h2>
                                                    @else
                                                        <p>No project associated with this issue.</p>
                                                    @endif

                                                    <span class="text-sm font-light text-gray-400">Updated 
                                                        {{ $singleIssue->created_at }}</span> 
                                                </td> 
                                                <td class="px-6 py-4 text-center">{{ $singleIssue->status }}</td> 
                                                <td class="px-6 py-4 text-center">{{ $singleIssue->developer }}</td> 
                                                <td class="px-6 py-4 text-center"> 
                                                    <!--<a href="{{ route('issues.show', $singleIssue->id) }}" 
                                                    ...
                                                    <a href="{{ route('issues.edit', $singleIssue->id) }}" 
                                                    ...
                                                    <form
                                                        ...
                                                        action="{{ route('issues.destroy', $singleIssue->id) }}" 
